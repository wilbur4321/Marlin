...
//#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PC9                  // Override the default pin if needed
...
#define NUM_Z_STEPPER_DRIVERS 2   // (1-4) Z options change based on how many
  ...
  #define INVERT_Z2_VS_Z_DIR true   // Set 'true' if Z2 motor should rotate in opposite direction from Z
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_GCODE
    ...
    #define MEASURE_BACKLASH_WHEN_PROBING
      ...
      #define BACKLASH_MEASUREMENT_LIMIT       1.0   // (mm)
      #define BACKLASH_MEASUREMENT_RESOLUTION  0.01 // (mm)
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.75    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
   ...
   */
   //#define TMC_HOME_PHASE { 640, 384, 640 }
